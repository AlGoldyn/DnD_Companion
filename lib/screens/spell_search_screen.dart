...
class _SpellSearchScreenState extends State<SpellSearchScreen> {
  ...
  int? _selectedLevel; // Selected spell level
                    ...
                    showDialog(
                      ...
                      builder: (ctx) => AlertDialog(
                        ...
                        content: SingleChildScrollView(
                          child: Text(spell.description ?? 'No description'),
                        ),
                        actions: [
                          TextButton(
          ...
          actions: [
            TextButton(
              onPressed: () {
                ...
                spellProvider.filterSpellsByLevel(_selectedLevel); // Apply filter
              },
              child: Text('Apply'),
            ),
            TextButton(
              onPressed: () {
                ...
                spellProvider.filterSpellsByLevel(null); // Clear filter
              },
              child: Text('Clear'),
            ),
          ],
